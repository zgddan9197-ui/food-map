...
exports.initialCommunityPosts = exports.places = exports.campuses = void 0;
const weekDays = [0, 1, 2, 3, 4, 5, 6];
const fullWeek = (start, end) => weekDays.map((day) => ({ day, start, end }));
const breakfastWeekday = () => [
    ...[1, 2, 3, 4, 5].map((day) => ({ day, start: '06:30', end: '10:30' })),
...
const wrapRating = (rating) => {
    const clamped = Math.max(3.9, Math.min(4.9, rating));
    return Math.round(clamped * 10) / 10;
};
const trustSummary = (keywords, revisitRate30d) => `多人提到${keywords.slice(0, 2).join('、')}，近30天回头率 ${revisitRate30d}%`;
exports.places = exports.campuses.flatMap((campus, campusIndex) => templates.map((template, templateIndex) => {
